...
export default {
  ...
  state: () => ({ 
    ...
    tldName: ".testmare",
    tldAddress: "0x681088850Bfa0E941aeFE1D029d648D700ac7f6a", // TODO
    tldContract: null,
    tldChainId: 80001,
    tldChainName: "Polygon Testnet",
    minterAddress: "0x66DC86E82A15FAfE14065B0B7531136D9c942bc3", // TODO
    minterContract: null,
    minterPaused: true,
    minterTldPrice1: 0.1,
    minterTldPrice2: 0.05,
    minterTldPrice3: 0.01,
    minterTldPrice4: 0.005,
    minterTldPrice5: 0.001,
    referralFee: 1000
  }),
